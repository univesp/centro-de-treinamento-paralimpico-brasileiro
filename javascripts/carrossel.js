$(document).ready(function(){
  ...
  function scrollParaContainer(container) {
      if (!container) return;
      ...
      // Se não estiver visível, faz o scroll
      if (!isVisible || rect.top < 50) {
  ...
  function initCarousel(container) {
      ...
      function updateCarousel(index) {
          ...
          // Scroll para o container após mudar o slide
          scrollParaContainer(container);
